...
import { deleteCurrentAvatar, getAvatarImage, getCurrentProfile, patchCurrentProfile, postAvatar } from "./profile.controller.js";
...
profileRouter.get("/avatars/:publicId", getAvatarImage);
